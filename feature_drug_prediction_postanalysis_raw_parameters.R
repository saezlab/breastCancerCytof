...
# show_features_on_heatmap(features,fileName ="./figures/drug_prediction/parameter_feature_heatmap.pdf" )
...
if(FALSE) ggsave("./figures/drug_prediction/RMSE_random_vs_original_drug_vulcano_parameter_based.pdf",width = 9,height = 7)
...
if(FALSE)  ggsave("./figures/drug_prediction/RMSE_random_vs_original_3test_pvalues_parameter_based.pdf",width = 9,height = 7)
...
if(FALSE) ggsave("./figures/drug_prediction/RMSE_random_vs_original_violin_parameter_features.pdf",width = 12, height = 9)

### Parameter tests ************
# for the models with significant improvement, which are the predicting parameters
library(gridExtra)
if(FALSE)  pdf("./figures/drug_prediction/parameter_importance.pdf",width = 10,height = 9)
...
saveRDS(drug_targets,file="./data/models/pkn_v4_midas_v4/features_vs_drug/signif_drugs_by_rawPars.RDS")
